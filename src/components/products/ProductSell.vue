            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" v-model="selectedProduct" @change="productSelected">
                        ...
                        <option :disabled="product.count == 0" :value="product.key"  v-for="(product,id) in getProducts" :key="id"> {{ product.title }} </option>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 text-center">
                                <div class="mb-3">
                                    <span class="badge badge-info bg-success">Stok : {{ product.count }}</span>
                                    <span class="badge badge-primary bg-danger">Fiyat : {{ product.price | currency }}</span>
                                </div>
