            ...
            <div class="col-12 mb-5 card mt-5 shadow">
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped table-bordered" v-if="getProducts.length > 0">
                        ...
                        <tbody>
                        <tr v-for="(product,id) in getProducts" :key="id">
                            <td class="align-middle text-center"><span class="badge badge-info bg-primary"> {{ product.key }} </span></td>
                            <td class="align-middle text-center"> {{ product.title }} </td>
                            <td class="align-middle text-center" :class="getCountColor(product.count)"> {{ product.count }} </td>
